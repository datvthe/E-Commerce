  ...
  <body>
    <aside class="sidebar-nav-wrapper">
      ...
      <nav class="sidebar-nav">
                ...
                <c:set var="blogModPath" value="${ctx}/admin/blog-moderation" />
                ...
                <ul>
                    ...
                    <li class="nav-item nav-item-has-children">
                        ...
                        <ul id="ddmenu_2" class="collapse show dropdown-nav">
                            ...
                            <li>
                                <a href="${blogModPath}" class="${fn:startsWith(uri, blogModPath) ? 'active' : ''}"> 
                                    <i class="lni lni-write" style="margin-right: 5px;"></i>Quản lý Blog 
                                </a>
                            </li>
                            <li>
