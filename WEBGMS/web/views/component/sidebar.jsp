...
<html>
  <head>
    ...
    <link
      rel="stylesheet"
      href="<%= request.getContextPath() %>/views/assets/admin/assets/css/bootstrap.min.css"
    />
    <link
      rel="stylesheet"
      href="<%= request.getContextPath() %>/views/assets/admin/assets/css/lineicons.css"
    />
    <link
      rel="stylesheet"
      href="<%= request.getContextPath() %>/views/assets/admin/assets/css/materialdesignicons.min.css"
    />
    <link
      rel="stylesheet"
      href="<%= request.getContextPath() %>/views/assets/admin/assets/css/fullcalendar.css"
    />
    <link
      rel="stylesheet"
      href="<%= request.getContextPath() %>/views/assets/admin/assets/css/main.css"
    />
  </head>
  <body>
    <!--         ======== Preloader =========== 
    ...
    <aside class="sidebar-nav-wrapper">
        ...
        <ul>
          ...
          <li class="nav-item nav-item-has-children">
            ...
            <ul id="ddmenu_2" class="collapse show dropdown-nav">
              <li>
                <a
                  href="<%= request.getContextPath() %>/admin/categories"
                  class="active"
                >
                  Quản lý danh mục
                </a>
              ...
              <li>
                <a href="<%= request.getContextPath() %>/admin/cms/posts">
                  Quản lý bài viết
                </a>
              </li>
              <li>
                <a href="<%= request.getContextPath() %>/admin/cms/reviews">
                  Duyệt đánh giá
                </a>
              </li>
            </ul>
      ...
      <div class="promo-box">
        ...
        <p>
          Nâng cao quy trình phát triển và làm được nhiều hơn với PlainAdmin
          PRO!
        </p>
        <a
