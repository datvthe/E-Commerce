...
<html>
    <head>
        ...
        <link rel="stylesheet" href="<%= request.getContextPath() %>/views/assets/admin/assets/css/bootstrap.min.css" />
        <link rel="stylesheet" href="<%= request.getContextPath() %>/views/assets/admin/assets/css/lineicons.css" />
        <link rel="stylesheet" href="<%= request.getContextPath() %>/views/assets/admin/assets/css/materialdesignicons.min.css" />
        <link rel="stylesheet" href="<%= request.getContextPath() %>/views/assets/admin/assets/css/fullcalendar.css" />
        <link rel="stylesheet" href="<%= request.getContextPath() %>/views/assets/admin/assets/css/main.css" />
    </head>
    <body>
<!--         ======== Preloader =========== 
        <div id="preloader">
...
<span class="text">Bảng điều khiển</span>
                        ...
                        <ul id="ddmenu_1" class="collapse dropdown-nav">
                            <li>
                                <a href="<%= request.getContextPath() %>/admin/dashboard"> eCommerce </a>
                            </li>
                        </ul>
                    </li>
                    <li class="nav-item nav-item-has-children">
...
<span class="text">Thành phần UI </span>
                        </a>
...
<span class="text">Biểu tượng</span>
                        </a>
...
<p>Nâng cao quy trình phát triển và làm được nhiều hơn với PlainAdmin PRO!</p>
...
Nâng cấp lên PRO
        ...
        <script src="<%= request.getContextPath() %>/views/assets/admin/assets/js/Chart.min.js"></script>
        <script src="<%= request.getContextPath() %>/views/assets/admin/assets/js/dynamic-pie-chart.js"></script>
        <script src="<%= request.getContextPath() %>/views/assets/admin/assets/js/moment.min.js"></script>
        <script src="<%= request.getContextPath() %>/views/assets/admin/assets/js/fullcalendar.js"></script>
        <script src="<%= request.getContextPath() %>/views/assets/admin/assets/js/jvectormap.min.js"></script>
        <script src="<%= request.getContextPath() %>/views/assets/admin/assets/js/world-merc.js"></script>
        <script src="<%= request.getContextPath() %>/views/assets/admin/assets/js/polyfill.js"></script>
