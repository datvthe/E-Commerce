...
<html>
    ...
    <body>
                ...
                <div class="row g-4 align-items-center">
                    <div class="col-md-6 text-center text-md-start mb-md-0">
                        <span class="text-white"><a href="#" class="border-bottom text-white"><i
                                    class="fas fa-copyright text-light me-2"></i>Gicungco Marketplace System</a>, All right
                            reserved.</span>
                    </div>
                    <div class="col-md-6 text-center text-md-end text-white">
                        ...
                        Designed By <a class="border-bottom text-white" href="https://htmlcodex.com">Gicungco Marketplace System</a>.
        ...
        <script src="<%= request.getContextPath() %>/views/assets/user/lib/wow/wow.min.js"></script>
